...
import {
  allowanceOptions, banks, blankAllowance, blankBank, blankDeduction,
  deductionOptions, emptyProfile, groupOptions, restDayOptions,
  type Allowance, type Bank, type Deduction, type Profile, type Toast,
} from "./payroll.config";
