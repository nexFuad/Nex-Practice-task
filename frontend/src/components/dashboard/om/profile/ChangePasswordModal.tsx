...
export function ChangePasswordModal({
  ...
  const fields: Array<[keyof PasswordValues, string, string]> = [
      ...
      >
            ...
            <label key={name} className="block">
              ...
              <span className="relative block">
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-slate-200 px-4 pr-12 text-sm outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                />
                <button
                  type="button"
                  onClick={() =>
        ...
        <footer className="mt-8 flex justify-between gap-3">
          ...
          <button
            disabled={saving}
            type="submit"
            className="h-11 rounded-xl bg-neutral-900 px-7 text-sm font-medium text-white disabled:opacity-60"
          >
